...
func init_gpu(num_cascades : int) -> void:
	...
	var spectrum_compute_shader := context.load_shader("uid://bi5m21vuwub1b")
	var fft_butterfly_shader := context.load_shader("uid://blkvx1tyt5ol3")
	var spectrum_modulate_shader := context.load_shader("uid://q3s7nsixj1nn")
	var fft_compute_shader := context.load_shader("uid://c5nf8ddsmdjsj")
	var transpose_shader := context.load_shader("uid://jog6bqtc7py6")
	var fft_unpack_shader := context.load_shader("uid://b7oo6ngkleqj0")
